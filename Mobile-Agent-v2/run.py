...
while True:
    ...
    output_action = inference_chat(chat_action, 'gpt-4o-ca', API_url, token)
    ...
    if memory_switch:
        ...
        output_memory = inference_chat(chat_action, 'gpt-4o-ca', API_url, token)
    ...
    if reflection_switch:
        ...
        output_reflect = inference_chat(chat_reflect, 'gpt-4o-ca', API_url, token)
